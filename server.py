...
class MultiServer(object):
    ...
    def socket_bind(self):
        ...
        #     self.ui_sys.errormsgbox.setWindowTitle("Socket Error")
        #     self.ui_sys.errormsgbox.setText(f'{e}')
        #     self.ui_sys.errormsgbox.setIcon(QMessageBox.Icon.Warning)
        #     self.ui_sys.errormsgbox.exec()
        return
...
def create_workers(ui,host,port):
    """ Create worker threads (will die when main exits) """
    server = MultiServer(ui,host,port)
...
def main(ui,host,port):
    create_workers(ui,host,port)
    create_jobs()
